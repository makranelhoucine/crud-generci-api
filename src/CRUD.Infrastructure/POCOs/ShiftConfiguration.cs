...
namespace CRUD.Infrastructure.POCOs
{
    ...
    public partial class ShiftConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Shift>
    {
        ...
        public ShiftConfiguration(string schema)
        {
            ...
            Property(x => x.Id).HasColumnName(@"ShiftID").HasColumnType("tinyint").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
