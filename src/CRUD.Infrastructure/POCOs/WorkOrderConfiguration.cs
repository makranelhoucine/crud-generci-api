...
namespace CRUD.Infrastructure.POCOs
{
    ...
    public partial class WorkOrderConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WorkOrder>
    {
        ...
        public WorkOrderConfiguration(string schema)
        {
            ...
            Property(x => x.Id).HasColumnName(@"WorkOrderID").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            ...
            HasOptional(a => a.ScrapReason).WithMany(b => b.WorkOrders).HasForeignKey(c => c.ScrapReasonId).WillCascadeOnDelete(false);
            HasRequired(a => a.Product).WithMany(b => b.WorkOrders).HasForeignKey(c => c.ProductId).WillCascadeOnDelete(false);
            InitializePartial();
        }
