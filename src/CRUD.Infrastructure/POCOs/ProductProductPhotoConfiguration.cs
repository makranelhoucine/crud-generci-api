...
namespace CRUD.Infrastructure.POCOs
{
    ...
    public partial class ProductProductPhotoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ProductProductPhoto>
    {
        ...
        public ProductProductPhotoConfiguration(string schema)
        {
            ...
            HasRequired(a => a.Product).WithMany(b => b.ProductProductPhotoes).HasForeignKey(c => c.ProductId).WillCascadeOnDelete(false);
            HasRequired(a => a.ProductPhoto).WithMany(b => b.ProductProductPhotoes).HasForeignKey(c => c.ProductPhotoId).WillCascadeOnDelete(false);
            InitializePartial();
        }
