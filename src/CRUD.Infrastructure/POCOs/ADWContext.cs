...
namespace CRUD.Infrastructure.POCOs
{
    ...
    public partial class ADWContext : System.Data.Entity.DbContext, IADWContext
    {
        ...
        static ADWContext()
        {
            System.Data.Entity.Database.SetInitializer<ADWContext>(null);
        }

        public ADWContext()
            : base("Name=ADWContext")
        {
            InitializePartial();
        }

        public ADWContext(string connectionString)
            : base(connectionString)
        {
            InitializePartial();
        }

        public ADWContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model)
            : base(connectionString, model)
        {
            InitializePartial();
        }

        public ADWContext(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
            InitializePartial();
        }

        public ADWContext(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
